...
When you need to be able to access the specific elements on the page, like H2 tag (`<h2>`), a div tag (`<div>`), a button (`<button>`) or an image (`<img>`) you need to select hem first, and then you can add content, change content, listen for clicks, you can do anything you want with it.
